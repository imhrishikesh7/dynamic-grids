var productList = [
  ...
  var mainClothingDiv = document.getElementById("clothes");
  var mainAccessoriesgDiv = document.getElementById("accessories");
  
  for (var i = 0; i < productList.length; i++) {
    if (productList[i].isAccessory === false) {
      var cardDivClothing = document.createElement("div");
      ...
      mainClothingDiv.appendChild(cardDivClothing);
    } else {
      var cardDivAccessories = document.createElement("div");
